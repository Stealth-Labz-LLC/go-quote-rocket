    ...
    <div class="container">
        <div class="info-sec-inr">
            ...
            <div class="info-sec-links-col info-sec-links-col-3">
                ...
                <ul class="info-sec-links-list">
                    <li><a href="personal-loans.php<?= $queryParams ?>" alt="Personal Loans Quotes">Personal Loans</a></li>
            ...
            <div class="info-sec-links-col info-sec-links-col-5">
                ...
                <ul class="info-sec-links-list">
                    <li><a href="car-insurance.php<?= $queryParams ?>" alt="Car Insurance Quotes">Car Insurance</a></li>
...
<div class="footer">
    <div class="container">
        <div class="footer__inner">
            <p class="footer__text footer__text--1">© <?= date('Y') ?> Go Quote Rocket LLC | All Rights Reserved</p>
            <p class="footer__text footer__text--2"><a href="contact.php<?= $queryParams ?>" alt="Contact Go Quote Rocket">Contact</a> | <a href="about.php<?= $queryParams ?>" alt="About Go Quote Rocket">About</a> | <a href="terms.php<?= $queryParams ?>" alt="Go Quote Rocket Terms">Terms</a> | <a href="privacy.php<?= $queryParams ?>" alt="Go Quote Rocket Privacy Policy">Privacy</a></p>
        </div>
    </div>
</div>