@extends('layouts.app')
@section('title', 'Affordable Business Insurance in the USA | Go Quote Rocket')
@section('meta_description', 'Secure your business with comprehensive and affordable insurance. Compare business insurance quotes in the USA with Go Quote Rocket today.')
@section('body-class', 'inner_pg business_insurance')
...
<script type="application/ld+json">
{
    ...
    "mainEntity": [{
        ...
        },
        {
            ...
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "If you have employees, workers' compensation insurance is essential. It protects your business financially in case of workplace injuries or illnesses, and it's often legally required depending on your state."
            }
        },
        {
            "@type": "Question",
...
<div class="inner_sec1" id="choosePack">
    <div class="container">
        ...
        <div class="inner_sec1-form" id="toForm">
            <form method="POST" name="business_api1" id="business_form">
                @csrf
                <div class="form__field">
                    ...
                    <div class="form__input form__input--3">
                        ...
                        <div class="form_input_box">
                            <select name="business_cover_type" class="input-fld required" data-error-message="Please select your insurance type.">
                                ...
                                <option value="Rideshare_Insurance">Rideshare Insurance</option>
                                <option value="Construction_Vehicles">Construction & Heavy Equipment</option>
...
<div class="as-seen">
    ...
    <div class="brand__strip__scroller">
        <ul class="scroll__brand__list">
            <li><img src="{{ asset('images/nationwide-logo.svg') }}" alt="Nationwide Business Insurance Logo" class="dial-direct_logo"></li>
            <li><img src="{{ asset('images/progressive-logo.svg') }}" alt="Progressive Business Insurance Logo" class="virseker_logo"></li>
            <li><img src="{{ asset('images/liberty-mutual-logo.svg') }}" alt="Liberty Mutual Business Insurance Logo"></li>
            <li><img src="{{ asset('images/travelers-logo.svg') }}" alt="Travelers Business Insurance Logo" class="momentum_logo"></li>
            <li><img src="{{ asset('images/hartford-logo.svg') }}" alt="The Hartford Business Insurance Logo"></li>
            <li><img src="{{ asset('images/state-farm-logo.svg') }}" alt="State Farm Business Insurance Logo" class="budget_logo"></li>
        </ul>
    </div>
</div>
    ...
    <div class="container">
        ...
        <div class="sec2_inr">
            <div class="sec2_inr_bx">
                <img src="{{ asset('images/inner-sec2-img1.webp') }}" alt="Guy Using Quote Rocket For Insurance Quotes" width="381" height="291">
            ...
            <div class="sec2_inr_bx">
                <img src="{{ asset('images/inner-sec2-img3.webp') }}" alt="Trusted Business Insurance Experts" width="381" height="291">
                <div class="sec2_bx_content">
                ...
                <div class="inner_sec3_tab_content-box hideMob" id="tab_col_1">
                    <div class="inner_sec3_tab_content">
                        ...
                        <div class="inner_sec3_tab_img e-com_img showMob">
                            <img src="{{ asset('images/inner_sec3-business-tab1.webp') }}" alt="Commercial Property Insurance" width="500" height="450">
                        </div>
            ...
            <div class="mob-div">
                ...
                <div class="inner_sec3_tab_content-box" id="tab_col_2" style="display: none;">
                    <div class="inner_sec3_tab_content">
                        ...
                        <div class="inner_sec3_tab_img e-com_img showMob">
                            <img src="{{ asset('images/inner_sec3-business-tab2.webp') }}" alt="Employers' Liability Insurance" width="500" height="450">
                        </div>
                        ...
                        <ul class="inner_sec3_tab-lst">
                            ...
                            <li><strong>Regulatory Compliance:</strong> Ensures you meet workplace safety and liability laws in your state.</li>
            ...
            <div class="mob-div">
                ...
                <div class="inner_sec3_tab_content-box" id="tab_col_3" style="display: none;">
                    <div class="inner_sec3_tab_content">
                        ...
                        <div class="inner_sec3_tab_img e-com_img showMob">
                            <img src="{{ asset('images/inner_sec3-business-tab3.webp') }}" alt="Product Liability Insurance" width="500" height="450">
                        </div>
            ...
            <div class="mob-div">
                ...
                <div class="inner_sec3_tab_content-box" id="tab_col_4" style="display: none;">
                    <div class="inner_sec3_tab_content">
                        ...
                        <div class="inner_sec3_tab_img e-com_img showMob">
                            <img src="{{ asset('images/inner_sec3-business-tab4.jpg') }}" alt="Professional Indemnity Cover" width="500" height="450">
                        </div>
...
<div class="why_choose">
    <div class="container">
        <div class="why_choose_left">
            ...
            <p class="comn_text">Finding the right business insurance can feel overwhelming, but we're here to make it simple. At <a href="{{ route('home') }}" alt="Insurance Quotes">Quote Rocket</a>, we connect you with multiple authorized insurers, so you can compare options side by side. Our process is designed to save you time, reduce stress, and help you secure the most reliable and affordable coverage available.</p>
        </div>
    ...
    <div class="container">
        ...
        <div class="inner_sec4_inr">
            <div class="inner_sec4_inr_bx">
                <img src="{{ asset('images/inner-sec4-business-icon1.png') }}" alt="Property Damage Icon" class="inner_sec4_icn" width="200" height="124">
            ...
            <div class="inner_sec4_inr_bx">
                <img src="{{ asset('images/inner-sec4-business-icon2.png') }}" alt="Financial Protection from Liability Claims Icon" class="inner_sec4_icn" width="200" height="124">
            ...
            <div class="inner_sec4_inr_bx">
                <img src="{{ asset('images/inner-sec4-business-icon3.png') }}" alt="Employee Safety Icon" class="inner_sec4_icn" width="200" height="124">
            ...
            <div class="inner_sec4_inr_bx">
                <img src="{{ asset('images/inner-sec4-business-icon4.png') }}" alt="Compliance with Legal Requirements Icon" class="inner_sec4_icn" width="200" height="124">
                <h3>Compliance with<br> Legal Requirements</h3>
                <p>Many states require certain types of insurance for businesses, such as workers' compensation or liability insurance, to operate legally.</p>
            </div>

            <div class="inner_sec4_inr_bx">
                <img src="{{ asset('images/inner-sec4-business-icon5.png') }}" alt="Business Continuity After Disasters Icon" class="inner_sec4_icn" width="200" height="124">
            ...
            <div class="inner_sec4_inr_bx">
                <img src="{{ asset('images/inner-sec4-business-icon6.png') }}" alt="Peace of Mind Business Owner Icon" class="inner_sec4_icn" width="200" height="124">
            ...
            <div class="inner_sec4_inr_bx">
                <img src="{{ asset('images/inner-sec4-business-icon7.png') }}" alt="Client & Partner Confidence Icon" class="inner_sec4_icn" width="200" height="124">
            ...
            <div class="inner_sec4_inr_bx">
                <img src="{{ asset('images/inner-sec4-business-icon8.png') }}" alt="Protection from Cyber Threats Icon" class="inner_sec4_icn" width="200" height="124">
            ...
            <div class="inner_sec4_inr_bx">
                <img src="{{ asset('images/inner-sec4-business-icon9.png') }}" alt="Industry Specific Risks Icon" class="inner_sec4_icn" width="200" height="124">
        ...
        <div class="faq-container" style="overflow:hidden;">
            ...
            <div class="up-slide-dwn">
                <div class="faq-innr">
                    ...
                    <div class="acdn-content" style="display: none;">
                        <p class="acdn-para">If you have employees, workers' compensation insurance is essential. It protects your business financially in case of <a href="{{ route('products.show', 'legal-insurance') }}" alt="Legal Insurance Quotes">workplace injuries</a> or illnesses, and it's often legally required depending on your state.</p>
                    </div>
                </div>
            </div>
...
$(document).ready(function() {
    ...
    $("input[name='first_name'], input[name='last_name'], input[name='email'], input[name='phone']").on('keyup', function() {
        $(this).next('.error_message').hide();
    });
    $("select[name='business_cover_type'], select[name='state']").on('change', function() {
        $(this).next('.error_message').hide();
    });
    ...
    $('.apiBtn').on('click', function() {
        ...
        $('input[name=phone], input[name=email], input[name=first_name], input[name=last_name], select[name=business_cover_type], select[name=state]').each(function() {
            var input = $(this);
    ...
    function submitLead() {
        ...
        let formData = {
            ...
            product_type: 'business_insurance',
            first_name: $("input[name='first_name']").val(),
            last_name: $("input[name='last_name']").val(),
            phone: phoneDigits,
            email: $("input[name='email']").val(),
            state: $("select[name='state']").val(),
            business_cover_type: $("select[name='business_cover_type']").val(),
